...
appModule.config(/*ngInject*/ function ($httpProvider: ng.IHttpProvider, $urlRouterProvider: angular.ui.IUrlRouterProvider,
    ...
    let description = 'Organize Trello cards across all boards in one amazing calendar view. ' +
        'Get the most out of Trello and improve your workflow with our open source calendar!';
    $stateProvider.state('trello', {
            url: '',
            views: {
        ...
        .state('trello.app.token', {
            ...
            resolve: {
                setToken: function ($stateParams, $location, setToken: SetTokenService) {
